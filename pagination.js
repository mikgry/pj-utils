function pagination(a) {
    var e = "<ul class='pagination'>";
    leftnum = parseInt(numshowpage / 2), leftnum == numshowpage - leftnum && (numshowpage = 2 * leftnum + 1), start = postnumber - leftnum, start < 1 && (start = 1), maximum = parseInt(a / postperpage) + 1, maximum - 1 == a / postperpage && (maximum -= 1), end = start + numshowpage - 1, end > maximum && (end = maximum), e += "<span class='totalpages'>Strona " + postnumber + " z " + maximum + "</span>";
    var s = parseInt(postnumber) - 1;
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<span class="showpage"><a href="' + "/search?max-results=9" + '">' + prevpage + "</a></span>" : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">' + prevpage + "</a></li>" : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></li>"), start > 1 && (e += "page" == type ? '<li class="page-item"><a class="page-link" href="/search?max-results=15">1</a></li>' : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<li class="page-item active">' + r + "</li>" : 1 == r ? "page" == type ? '<li class="page-item"><a class="page-link" href="/search?max-results=15">1</a></li>' : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>' : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + r + ');return false">' + r + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + r + ');return false">' + r + "</a></li>";
    ...
    postnumber < maximum && (e += "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + n + ');return false">' + nextpage + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + n + ');return false">' + nextpage + "</a></li>");
    e += "</ul>";
