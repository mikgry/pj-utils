function pagination(a) {
    ...
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<li class="page-item"><a class="page-link" href="' + "/search?max-results=15" + '" aria-label="Previous"><span aria-hidden="true">&laquo;</span><span class="sr-only">' + prevpage + "</span></a></span>" : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + ' aria-label="Previous""><span aria-hidden="true">&laquo;</span><span class="sr-only">' + prevpage + "</span></a></li>" : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></li>"), start > 1 && (e += "page" == type ? '<li class="page-item"><a class="page-link" href="/search?max-results=15">1</a></li>' : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<li class="page-item active"><a href="#">' + r + "</a></li>" : 1 == r ? "page" == type ? '<li class="page-item"><a class="page-link" href="/search?max-results=15">1</a></li>' : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>' : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + r + ');return false">' + r + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + r + ');return false">' + r + "</a></li>";
